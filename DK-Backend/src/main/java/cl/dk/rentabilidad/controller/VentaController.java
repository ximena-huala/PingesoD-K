...
public class VentaController {
    ...
    @PostMapping
    public ResponseEntity<VentaDto> registrar(@RequestBody Venta venta) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<VentaDto> obtenerPorId(@PathVariable UUID id) {
    ...
    public ResponseEntity<List<VentaDto>> porCanal(@PathVariable UUID canalId) {
